...
int ATANode::read( int64 pos, void *buffer, int len )
{
   long lba = pos / 512;
   int sectors = len / 512;
   int left    = len % 512;
...
int ATANode::write( int64 pos, void *buffer, int len )
{
   long lba = pos / 512;
   int sectors = len / 512;
   int    left = len % 512;
...
void ATANode::pio_set_iobase_addr( unsigned int base1, unsigned int base2 )
{
...
void ATANode::reg_wait_poll( int we, int pe )
...
unsigned char ATANode::pio_inbyte( unsigned int addr )
{
...
void ATANode::pio_outbyte( unsigned int addr, unsigned char data )
{
   unsigned int regAddr;
   unsigned char * ucp;
...
unsigned int ATANode::pio_inword( unsigned int addr )
{
   unsigned int regAddr;
   unsigned int ui;
   unsigned int * uip;
...
void ATANode::pio_outword( unsigned int addr, unsigned int data )
{
   unsigned int regAddr;
   unsigned int * uip;
...
void ATANode::pio_rep_inbyte( unsigned int addrDataReg,
                     void* buffer,
                     long byteCnt )
{
...
void ATANode::pio_rep_outbyte( unsigned int addrDataReg,
		      void* buffer,
                      long byteCnt )
{
   unsigned int dataRegAddr;
...
void ATANode::pio_rep_indword( unsigned int addrDataReg,
                      void* buffer,
...
void ATANode::pio_rep_outdword( unsigned int addrDataReg,
                       void* buffer,
                       unsigned int dwordCnt )
{
   unsigned int dataRegAddr;
...
void ATANode::pio_rep_inword( unsigned int addrDataReg,
                     void* buffer,
...
void ATANode::pio_rep_outword( unsigned int addrDataReg,
                      void* buffer,
                      unsigned int wordCnt )
...
int ATANode::reg_reset( int skipFlag, int devRtrn )
...
void ATANode::sub_zero_return_data( void )
...
void ATANode::sub_atapi_delay( int dev )
{
...
void ATANode::sub_xfer_delay( void )
...
void ATANode::sub_trace_command( void )
{
...
int ATANode::sub_select( int dev )
{
   unsigned char status;
...
void ATANode::tmr_set_timeout( void )
...
int ATANode::tmr_chk_timeout( void )
{
...
unsigned int ATANode::tmr_read_bios_timer( void )
{
...
int ATANode::reg_pio_data_in_lba( int dev, int cmd,
                         int fr, int sc,
                         long lba,
			 void* buffer,
...
int ATANode::reg_pio_data_in( int dev, int cmd,
                     int fr, int sc,
...
int ATANode::reg_pio_data_out_lba( int dev, int cmd,
                          int fr, int sc,
                          long lba,
			  void* buffer,
                          int numSect, int multiCnt )
...
int ATANode::reg_pio_data_out( int dev, int cmd,
                      int fr, int sc,
                      unsigned int cyl, int head, int sect,
                      void* buffer,
                      int numSect, int multiCnt )
