...
class ATAPINode : public DeviceNode
{
   ...
   private:
	...
	void Reset( bool setflags = true );

   private:
       int reg_packet( int cmdSize, void *cmd, int dir,
       			   long bufSize, void* buffer,
			   unsigned long lba );
